...
CREATE TABLE `employee_address` (
  ...
  PRIMARY KEY (`address_id`,`employee_employee_id`,`employee_address_id`),
  KEY `FKqq0en5qmmtf6hqu0c39wr1wj8` (`address_address_id`),
  KEY `FK5x51icjcmly6tverb8w8jmdps` (`employee_employee_id`)
