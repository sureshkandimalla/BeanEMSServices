...
public interface PayrollRepository extends JpaRepository<Payroll, Long> {
    ...
    @Query("SELECT new com.employeehub.model.Payroll(p.payrollId, p.payCheckId, p.employeeId, pp.startDate, pp.payDate, pp.endDate, p.hours, p.totalPaid, p.taxWithheld, p.deductions, p.netPay, p.employerLiability, p.notes, p.LastUpdated) " +
